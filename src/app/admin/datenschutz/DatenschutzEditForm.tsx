...
export default function DatenschutzEditForm({
  ...
  const adresse = [impressum.strasse, `${impressum.plz} ${impressum.ort}`.trim()].filter(Boolean).join(", ");
        ...
        <div className="border-t border-gray-100 pt-3 grid grid-cols-1 gap-1.5 text-sm">
          {impressum.firmenname && (
            <div className="flex gap-2">
              ...
              <span className="text-gray-700 font-medium">{impressum.firmenname}</span>
            </div>
          )}
          {impressum.inhaberName && (
            <div className="flex gap-2">
              <span className="w-28 shrink-0 text-xs text-gray-400">Inhaber</span>
              <span className="text-gray-700">{impressum.inhaberName}</span>
            </div>
          )}
          {adresse && (
            <div className="flex gap-2">
          ...
          {impressum.telefon && (
            <div className="flex gap-2">
              ...
              <span className="text-gray-700">{impressum.telefon}</span>
            </div>
          )}
          {impressum.email && (
            <div className="flex gap-2">
          ...
          {!impressum.firmenname && !impressum.inhaberName && !adresse && !impressum.telefon && !impressum.email && (
